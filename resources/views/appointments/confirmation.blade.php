        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow-sm border-success">
                <div class="card-body text-center">
                    ...
                    <h2 class="mb-4">Appointment Booked Successfully!</h2>
                    ...
                    <div class="alert alert-info my-4">
                        ...
                        <h3 class="mb-0">{{ $appointment->confirmation_code }}</h3>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 text-md-start">{{ $appointment->vaccine->name }}</div>
                            </div>
                            
                            <div class="row mb-2">
                                <div class="col-md-6 text-md-end"><strong>Date:</strong></div>
                                <div class="col-md-6 text-md-start">{{ \Carbon\Carbon::parse($appointment->appointment_date)->format('l, F j, Y') }}</div>
                            </div>
                            
                            <div class="row mb-2">
                                <div class="col-md-6 text-md-end"><strong>Time:</strong></div>
                                <div class="col-md-6 text-md-start">{{ $appointment->time_slot }}</div>
                            </div>
                    ...
                    <p>We've sent a confirmation email to <strong>{{ $appointment->email }}</strong> with all the details.</p>
