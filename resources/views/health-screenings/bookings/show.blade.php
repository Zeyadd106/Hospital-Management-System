        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    {{ __('Health Screening Booking Details') }}
                    <a href="{{ route('health-screenings.booking.index') }}" class="btn btn-secondary btn-sm">
                        Back to Bookings
                    </a>
                </div>
                ...
                <div class="card-body">
                    ...
                    @if($booking->status == 'pending')
                        <div class="row">
                            <div class="col-12">
                                <a href="{{ route('health-screenings.booking.edit', $booking->id) }}" class="btn btn-warning me-2">
                                    Edit Booking
                                </a>
