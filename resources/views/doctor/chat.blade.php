...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <h2 class="mb-4">Patient Conversations</h2>
            ...
            <div class="chat-container">
                ...
                <div class="chat-window">
                    ...
                    <div class="mt-3 d-flex gap-2">
                        <button class="quick-action btn btn-outline-primary btn-sm" data-message="How are you feeling today?">
                            <i class="fas fa-heart"></i>
                            Check-in
                        </button>
                        <button class="quick-action btn btn-outline-primary btn-sm" data-message="Your test results are ready. Would you like to schedule a follow-up appointment?">
                            <i class="fas fa-file-medical"></i>
                            Test Results
                        </button>
                        <button class="quick-action btn btn-outline-primary btn-sm" data-message="Remember to take your medication as prescribed.">
