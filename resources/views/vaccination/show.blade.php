...
<div class="booking-details-section">
    <div class="container">
        <div class="booking-details-header">
            <h2>Vaccination Booking Details</h2>
            <p>Review your vaccination appointment details below</p>
        </div>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="booking-details-card">
                    ...
                    <div class="booking-info-item">
                        <div class="booking-info-label">Vaccination Type</div>
                        <div>{{ $booking->vaccination_type }}</div>
                    </div>
                    ...
                    <div class="action-buttons">
                        @if($booking->status == 'pending')
                            <a href="{{ route('vaccinations.edit', $booking->id) }}" class="btn btn-primary me-2">Edit Booking</a>
                        ...
                        <a href="{{ route('vaccinations.index') }}" class="btn btn-secondary ms-2">Back to Vaccinations</a>
                    </div>
                </div>
            </div>
        </div>
